...
for (i in 1:length(date)){
  ...
  numofcheckin = c(numofcheckin,number)
}
summary(numofcheckin)
numofcheckintable <- as.data.frame(table(numofcheckin))
colnames(numofcheckintable)[2] <- "numofrest"
head(numofcheckintable)
plot(numofcheckintable$numofcheckin,numofcheckintable$Freq)
sum(numofcheckin>8000)
```
